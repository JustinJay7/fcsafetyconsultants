  ...
  return (
    <footer id="contact" className="section-padding section-blue">
      <div className="container mx-auto max-w-4xl text-center">
        <h2
          ref={heading.ref}
          className={`font-display text-3xl font-extrabold text-safety-blue-foreground md:text-4xl mb-10 ${heading.className}`}
        >
          Get In Touch
        </h2>
        ...
        <div className="grid gap-8 md:grid-cols-2 text-left mb-12">
          ...
          <div className="space-y-4 text-safety-blue-foreground">
            <h3 className="font-display font-bold text-lg">Our Address</h3>
            <a
